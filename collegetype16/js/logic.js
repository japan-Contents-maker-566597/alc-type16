const QUESTIONS_STUDENT_TEXTS = [
  "大学生活でのメインの収入源と、お金の使い方は？",
  "大学生活で、一番「自分の居場所」だと感じるのは？",
  "大学生活の「金曜日の夜」、よくある過ごし方は？",
  "大学の授業・成績に対するスタンスは？",
  "キャンパスにいる時の、ファッションや見た目へのこだわりは？",
  "大学生活のSNS（InstagramやXなど）での発信内容は？",
  "日々の生活で、一番「テンションが上がる」瞬間は？",
  "友達から真剣な悩みを相談されたら、どう対応する？",
  "スマホを見ている時、一番開いている時間が長いアプリは？",
  "まとまったお金（10万円）が手に入ったらどうする？",
  "大学生活での「恋愛」に対するスタンスは？",
  "キャンパスで顔見知りを見つけたら？",
  "恋人や親友に、一番「求めている」要素は？",
  "キャンパスライフを送る中で、一番「不安」に感じる要素は？",
  "最終的に「どんな人生を送りたい」と、思い描いている？"
];
const QUESTIONS_ALUMNI_TEXTS = [
  "大学生活でのメインの収入源と、お金の使い方は？",
  "大学生活で、一番「自分の居場所」だと感じていたのは？",
  "大学生活の「金曜日の夜」、よくあった過ごし方は？",
  "大学の授業・成績に対するスタンスは？",
  "キャンパスにいた時の、ファッションや見た目へのこだわりは？",
  "大学生活のSNS（InstagramやXなど）での発信内容は？",
  "日々の生活で、一番「テンションが上がっていた」瞬間は？",
  "友達から真剣な悩みを相談されたら、どう対応していた？",
  "スマホを見ている時、一番開いている時間が長かったアプリは？",
  "まとまったお金（10万円）が手に入ったらどうしていた？",
  "大学生活での「恋愛」に対するスタンスは？",
  "キャンパスで顔見知りを見つけたら？",
  "恋人や親友に、一番「求めていた」要素は？",
  "キャンパスライフを送る中で、一番「不安」に感じていた要素は？",
  "最終的に「どんな人生を送りたい」と、思い描いていた？"
];


function setDiagnosisQuestions(mode) {
    const texts = mode === 'alumni' ? QUESTIONS_ALUMNI_TEXTS : QUESTIONS_STUDENT_TEXTS;
    QUESTIONS.forEach((q, i) => {
        if (texts[i]) q.text = texts[i];
    });
}
const QUESTIONS = [
  {
    "id": 1,
    "text": "大学生活でのメインの収入源と、お金の使い方は？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 2,
    "text": "大学生活で、一番「自分の居場所」だと感じる（感じていた）のは？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 3,
    "text": "大学生活の「金曜日の夜」、よくある（あった）過ごし方は？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 5,
    "text": "キャンパスにいる時の、ファッションや見た目へのこだわりは？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 6,
    "text": "大学生活のSNS（InstagramやXなど）での発信内容は？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 7,
    "text": "日々の生活で、一番「テンションが上がる（上がっていた）」瞬間は？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 8,
    "text": "友達から真剣な悩みを相談されたら、どう対応する（していた）？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 9,
    "text": "スマホを見ている時、一番開いている時間が長い（長かった）アプリは？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 10,
    "text": "まとまったお金（10万円）が手に入ったらどうする（どうしていた）？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 13,
    "text": "恋人や親友に、一番「求めている（求めていた）」要素は？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 14,
    "text": "キャンパスライフを送る中で、一番「不安」に感じる（感じていた）要素は？",
    "choices": [
      {
        "key": "A",
  ...
  {
    "id": 15,
    "text": "最終的に「どんな人生を送りたい」と、思い描いている（いた）？",
    "choices": [
      {
        "key": "A",
